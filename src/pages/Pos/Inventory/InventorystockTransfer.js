// src/pages/POS/Inventory/InventoryStockTransfer.js
...
export default function InventoryStockTransfer() {
  ...
  const mockData = [
    {
      id: 1,
      date: "08/06/2025",
      transactionNo: "STOCKTRANSFER1",
      departmentName: "STORE (MUS)",
      departmentTypeName: "Department"
    },
    {
      id: 2,
      date: "08/05/2025",
      transactionNo: "STOCKTRANSFER2",
      departmentName: "PRODUCTION DEPT",
      departmentTypeName: "Department"
    },
    {
      id: 3,
      date: "08/04/2025",
      transactionNo: "STOCKTRANSFER3",
      departmentName: "WAREHOUSE A",
      departmentTypeName: "Warehouse"
    },
    {
      id: 4,
      date: "08/03/2025",
      transactionNo: "STOCKTRANSFER4",
    ...
    },
    {
      id: 8,
      date: "07/30/2025",
      transactionNo: "STOCKTRANSFER8",
      departmentName: "SHIPPING DEPT",
      departmentTypeName: "Department"
    }
  ];
  ...
  const handleAddStockTransfer = () => {
    console.log("Add Stock Transfer clicked");
        ...
        <div style={styles.container}>
          ...
          <div style={styles.pageHeader}>
            <div style={styles.headerLeft}>
              ...
              <h2 style={styles.pageTitle}>Stock Transfer Details</h2>
            </div>
          ...
          <div style={styles.actionBar}>
            <button style={styles.btnAdd} onClick={handleAddStockTransfer}>
              Add Stock Transfer
            </button>
          </div>
...
//         `/api/inventory/stock-transfers?${queryParams}`,
//         {
//           method: "GET",
//         }
//       );
...
//   const handleAddStockTransfer = useCallback(() => {
//     console.log("Add Stock Transfer clicked");
//     // Navigate to add page or open modal
//     // Example: navigate("/inventory/stock-transfer/add");
//   }, []);
...
//     try {
//       const response = await apiFetch(
//         `/api/inventory/stock-transfers/${row.id}`,
//         {
//           method: "GET",
//         }
//       );
...
//       if (response.success) {
//         console.log("Edit transfer data:", response.data);
//         // Navigate to edit page with data
//         // Example: navigate(`/inventory/stock-transfer/edit/${row.id}`, { state: response.data });
//       }
//     } catch (err) {
//       console.error("Failed to fetch transfer details for editing:", err);
...
//       if (
//         !window.confirm(
//           `Are you sure you want to delete transfer ${row.transactionNo}?`
//         )
//       ) {
//         return;
//       }
