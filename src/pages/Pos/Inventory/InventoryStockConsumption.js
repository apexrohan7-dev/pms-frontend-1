...
export default function InventoryStockConsumption() {
  ...
  const styles = {
    ...
    filterRow: {
      display: 'grid',
      gridTemplateColumns: '1fr 1fr 2fr 0.8fr',
      gap: '15px',
      alignItems: 'end'
    },
    filterItem: {
      ...
      <div style={styles.page}>
        ...
        <div style={styles.container}>
          ...
          <div style={styles.actionBar}>
            <button style={styles.btnAddStock} onClick={handleAddStockManual}>
              Add Stock Manual
            </button>
          </div>
...
//         `/api/inventory/stock-consumption?${queryParams}`,
//         {
//           method: "GET",
//         }
//       );
...
//       setLoading(false);
//     }
//   }, [currentPage, itemsPerPage, fromDate, toDate, item]);
...
//   // Handle add stock manual
//   const handleAddStockManual = useCallback(() => {
//     console.log("Add Stock Manual clicked");
//     // Navigate to add page or open modal
//     // Example: navigate("/inventory/stock-consumption/add");
//   }, []);
...
//     try {
//       const response = await apiFetch(
//         `/api/inventory/stock-consumption/${row.id}`,
//         {
//           method: "GET",
//         }
//       );
...
//         // Example: navigate(`/inventory/stock-consumption/view/${row.id}`);
//       }
//     } catch (err) {
//       console.error("Failed to fetch consumption details:", err);
//       alert("Failed to load consumption details");
//     }
//   }, []);
...
//                   Stock Manual Consumption Details
//                 </h2>
//               </div>
//             </div>
...
//                       <option key={index} value={itemObj.id || itemObj.name}>
//                         {itemObj.name}
//                       </option>
//                     ))}
//                   </select>
