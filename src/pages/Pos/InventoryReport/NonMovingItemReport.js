...
//   const [subCategory, setSubCategory] = useState("");
//   const [item, setItem] = useState("");
//   const [lastDayIssueNo, setLastDayIssueNo] = useState("30");
//   const [movementType, setMovementType] = useState("slow");
...
//   // Fetch non-moving items report data
...
//       const response = await apiFetch(
//         `/api/inventory/reports/non-moving-items?${queryParams}`,
//         {
//           method: "GET",
//         }
//       );
...
//       const response = await apiFetch(
//         `/api/inventory/reports/non-moving-items/export?${queryParams}`,
//         {
//           method: "GET",
//           responseType: "blob",
//         }
...
//       link.setAttribute(
//         "download",
//         `Non_Moving_Items_Report_${new Date().toISOString().split("T")[0]}.xlsx`
//       );
...
//       setExporting(false);
//     }
//   }, [movementType, lastDayIssueNo, category, subCategory, item]);
...
//                   Last Days (No Movement)
//                 </label>
//                 <input
//                   type="number"
//                   style={styles.filterInput}
//                   value={lastDayIssueNo}
//                   onChange={(e) => setLastDayIssueNo(e.target.value)}
//                   placeholder="30"
//                   min="1"
//                 />
//               </div>
...
//                   <input
//                     type="radio"
//                     checked={movementType === "slow"}
//                     onChange={() => setMovementType("slow")}
//                   />
//                   Slow Moving
//                 </label>
//                 <label style={styles.radioLabel}>
//                   <input
//                     type="radio"
//                     checked={movementType === "fast"}
//                     onChange={() => setMovementType("fast")}
//                   />
//                   Fast Moving
//                 </label>
//                 <label style={styles.radioLabel}>
//                   <input
//                     type="radio"
//                     checked={movementType === "no"}
//                     onChange={() => setMovementType("no")}
//                   />
//                   No Moving
//                 </label>
//               </div>
...
//                   <p>Loading non-moving items data...</p>
//                 </div>
//               ) : (
//                 <table style={styles.dataTable}>
//                   <thead style={styles.tableHead}>
...
//                       <th style={styles.th}>Last Movement Date</th>
//                       <th style={styles.th}>Days Since Movement</th>
...
//                           </td>
//                           <td style={styles.td}>
//                             {row.lastMovementDate || "Never"}
//                           </td>
//                           <td style={styles.td}>{row.daysSinceMovement || 0}</td>
//                           <td style={styles.td}>
//                             <span style={getStatusBadgeStyle(row.movementStatus)}>
//                               {row.movementStatus === "fast"
//                                 ? "Fast Moving"
//                                 : row.movementStatus === "slow"
//                                 ? "Slow Moving"
//                                 : "Non Moving"}
//                             </span>
//                           </td>
...
//                             No {movementType} moving items found for selected
//                             filters
//                           </div>
//                         </td>
//                       </tr>
