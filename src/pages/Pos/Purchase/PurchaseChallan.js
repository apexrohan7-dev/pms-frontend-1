...
export default function PurchaseChallan() {
  ...
  // Example: No data loaded—empty results
  const challans = [];
      ...
      <div style={styles.page}>
        <div style={styles.container}>
          ...
          <div style={styles.pageHeader}>
            ...
            <span style={styles.pageTitle}>Purchase-challan</span>
            <div style={styles.actionBtnsTop}>
              <button style={styles.btnAdd}>Add Purchase-challan</button>
              <button style={styles.btnGen}>Generate Purchase For Purchase-challan</button>
          ...
          <div style={styles.dataTableContainer}>
            <table style={styles.dataTable}>
              ...
              <tbody>
                {/* Empty state, render row for no data if needed */}
              </tbody>
            </table>
          </div>
          {/* Pagination & Total */}
...
//   const [statusList] = useState(["All", "Open", "Closed", "Cancelled"]);
...
//   // Load parties for party dropdown
//   useEffect(() => {
...
//       } catch (err) {
//         console.error("Failed to load party list", err);
//       }
//     }
//     loadParties();
//   }, []);
...
//         limit: itemsPerPage
//       });
//       const res = await apiFetch(`/api/purchase/challans?${params.toString()}`);
//       if (res.success) {
//         setChallans(res.data.rows || []);
...
//               <span style={styles.pageTitle}>Purchase-challan</span>
//               <div style={styles.actionBtnsTop}>
//                 <button style={styles.btnAdd} onClick={() => alert("Add Purchase-challan")}>Add Purchase-challan</button>
//                 <button style={styles.btnGen} onClick={() => alert("Generate Purchase for Purchase-challan")}>Generate Purchase For Purchase-challan</button>
...
//                 ))}
//               </select>
//               <button style={styles.filterBtn} onClick={() => fetchChallans()}>Search</button>
//             </div>
//             {/* Table */}
//             <div style={styles.dataTableContainer}>
//               <table style={styles.dataTable}>
...
//                         <td style={styles.td}>{row.taxableAmt}</td>
//                         <td style={styles.td}>{row.taxAmt}</td>
//                         <td style={styles.td}>{row.billAmt}</td>
//                         <td style={styles.td}>{row.createdBy}</td>
//                         <td style={styles.td}>{row.remark}</td>
//                         <td style={styles.td}>
//                           <button style={{ border: "none", background: "none", cursor: "pointer" }} title="Edit" onClick={() => alert("Edit not implemented")}>✏️</button>
//                           <button style={{ border: "none", background: "none", cursor: "pointer", color: "#d32f2f" }} title="Delete" onClick={() => alert("Delete not implemented")}>🗑️</button>
//                         </td>
//                       </tr>
//                     ))
//                   ) : (
//                     <tr>
//                       <td style={styles.td} colSpan={12}>No data found</td>
//                     </tr>
//                   ))}
//                 </tbody>
//               </table>
