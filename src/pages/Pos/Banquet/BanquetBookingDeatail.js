...
// // src/pages/POS/Banquet/BanquetBookingDetail.js
// import React, { useState, useEffect, useCallback } from "react";
// import PosSidebar from "../../../components/sidebar/Possidebar";
// import PosTopbar from "../../../components/layout/postopbar";
// import { apiFetch } from "../../../lib/api";

// export default function BanquetBookingDetail() {
//   const [venue, setVenue] = useState("");
//   const [functionFrom, setFunctionFrom] = useState("");
//   const [functionTo, setFunctionTo] = useState("");
//   const [handledBy, setHandledBy] = useState("");
...
//   const [statusOptions, setStatusOptions] = useState(["All", "Confirmed", "Cancelled", "Pending"]);
...
//   // Fetch venues and handlers on mount
//   useEffect(() => {
//     const fetchDropdowns = async () => {
//       try {
//         const [venuesRes, handlersRes] = await Promise.all([
//           apiFetch("/api/banquet/venues", { method: "GET" }),
//           apiFetch("/api/banquet/handlers", { method: "GET" }),
//         ]);
//         if (venuesRes.success) setVenues(venuesRes.data || []);
//         if (handlersRes.success) setHandlers(handlersRes.data || []);
//       } catch (err) {
...
//   // Fetch report data with filtering and pagination
...
//       const response = await apiFetch(`/api/banquet/bookings?${queryParams}`, { method: "GET" });

//       if (response.success) {
//         setReportData(response.data.bookings || []);
//         setTotalRecords(response.data.total || 0);
//       } else {
//         throw new Error(response.message || "Failed to fetch banquet bookings");
//       }
//     } catch (err) {
//       console.error("Error loading banquet bookings:", err);
//       setReportData([]);
//       setTotalRecords(0);
//       alert(err.message || "Failed to load banquet bookings.");
//     } finally {
//       setLoading(false);
//     }
//   }, [
...
//   const styles = {
//     // Styles same as your original code, adapted for clean layout...
//     layout: {
//       display: "flex",
//       minHeight: "100vh",
//       backgroundColor: "#f5f5f5",
...
//                   style={styles.filterInput}
//                   value={functionFrom}
//                   onChange={(e) => setFunctionFrom(e.target.value)}
...
//                   style={styles.filterInput}
//                   value={functionTo}
//                   onChange={(e) => setFunctionTo(e.target.value)}
//                   placeholder="To Date"
//                 />
//                 <select
//                   style={styles.filterInput}
...
//                   Show
//                 </button>
//                 <button style={styles.btnNewBooking} onClick={() => alert("New Booking placeholder")}>
//                   New Booking
//                 </button>
//               </div>
//             </div>
